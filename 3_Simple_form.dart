...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    theme: ThemeData(
      ...
      bottomNavigationBarTheme: BottomNavigationBarThemeData(backgroundColor: Colors.brown),
    ),
      home: HomePage(),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('My App'),
        actions: [
          IconButton(onPressed: (){mySnackBar('Mail me', context);}, icon: Icon(Icons.mail)),
